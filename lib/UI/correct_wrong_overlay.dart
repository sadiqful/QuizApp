          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                ...
                child: new Icon(widget._isCorrect==true ? Icons.done : Icons.clear,size:_iconAnimation.value*120.0,color: Colors.white,),
              )
            ),
            new Padding(padding: new EdgeInsets.only(bottom: 30.0),),
            new Text(widget._isCorrect==true ? "Correct !!" : "Wrong !!",style: new TextStyle(color:Colors.white,fontSize: 40.0,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),),
          ],
        ),
      ),
    );
